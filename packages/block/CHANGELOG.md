...
This release implements the constants block fields (`ommersHash`, `uncles`, `difficulty`, `extraData`, `mixHash`, `nonce`) in preparation for The Merge HF (EIP-3675), PR [#1393](https://github.com/ethereumjs/ethereumjs-monorepo/pull/1393)
